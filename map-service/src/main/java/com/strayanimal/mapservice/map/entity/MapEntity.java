...
import com.strayanimal.mapservice.map.dto.map.res.MapDetailResDto;
...
public class MapEntity {
    ...
    public MapSearchResDto fromEntityToListDto() {
        return MapSearchResDto.builder()
                .mapId(this.mapId)
                .addr1(this.addr1)
                .contentType(String.valueOf(this.contentType))
                .title(this.title)
                .mapx(this.mapx)
                .addressCode(String.valueOf(this.addressCode))
                .mapy(this.mapy)
                .build();
    }

    public MapDetailResDto fromEntityToDetailDto() {
        return MapDetailResDto.builder()
                .mapId(this.mapId)
                .addr1(this.addr1)
                .addr2(this.addr2)
                .addressCode(String.valueOf(this.addressCode))
